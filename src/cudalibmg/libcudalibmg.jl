...
function cudaLibMgGetVersion()
    initialize_api()
    @runtime_ccall((:cudaLibMgGetVersion, var"libcudalibmg()"), Csize_t, ())
end

function cudaLibMgGetCudartVersion()
    initialize_api()
    @runtime_ccall((:cudaLibMgGetCudartVersion, var"libcudalibmg()"), Csize_t, ())
end

function cudaLibMgCreateMatrixDesc(desc, numRows, numCols, rowBlockSize, colBlockSize,
                                   dataType, grid)
    initialize_api()
    @runtime_ccall((:cudaLibMgCreateMatrixDesc, var"libcudalibmg()"), cudaLibMgStatus_t,
...
function cudaLibMgDestroyMatrixDesc(desc)
    initialize_api()
    @runtime_ccall((:cudaLibMgDestroyMatrixDesc, var"libcudalibmg()"), cudaLibMgStatus_t,
...
function cudaLibMgCreateDeviceGrid(grid, numRowDevices, numColDevices, deviceIds, mapping)
    initialize_api()
    @runtime_ccall((:cudaLibMgCreateDeviceGrid, var"libcudalibmg()"), cudaLibMgStatus_t,
...
function cudaLibMgDestroyGrid(grid)
    initialize_api()
    @runtime_ccall((:cudaLibMgDestroyGrid, var"libcudalibmg()"), cudaLibMgStatus_t,
                   (cudaLibMgGrid_t,),
                   grid)
end
...
function cudaLibMgGetLocalMatrixDimensions(desc, numRows, numCols)
    initialize_api()
    @runtime_ccall((:cudaLibMgGetLocalMatrixDimensions, var"libcudalibmg()"), cudaLibMgStatus_t,
